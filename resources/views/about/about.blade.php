<x-web-layout>
                ...
                <div class="col-lg-6">
                    <div class="about-content text-center">
                        ...
                        <p data-aos="fade-up" data-aos-delay="400">Lorem ipsum dolor sit amet, consectetur adipisicing
                            elit, sed do eiusmod tempor incidi ut labore et dolore magna aliqua. Ut enim ad minim venia
                            quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
                            irure dolor in reprehenderit</p>
                        <p class="mrg-inc" data-aos="fade-up" data-aos-delay="500">in voluptate velit esse cillum
                            dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in
                            culpa qui officia deserunt mollit anim id est laborum.</p>
                        <div class="btn-style-3 btn-hover" data-aos="fade-up" data-aos-delay="600">
                            <a class="btn border-radius-none" href="{{ route('busqueda') }}">Shop Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about-img" data-aos="fade-up" data-aos-delay="400">
                        <img src="{{ asset('assets/images/about/about-us.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="single-testimonial" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectet adipisicing elit, sed do eiusmod tempo incididunt
    ...
    <div class="funfact-area bg-img pt-100 pb-70"
        style="background-image:url({{ asset('assets/images/bg/bg-4.png') }})">
        <div class="container">
            <div class="row">
