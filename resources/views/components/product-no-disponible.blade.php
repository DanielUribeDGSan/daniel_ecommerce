<div class="">
    ...
    <div class="toast__container" style="    position: absolute;
    z-index: 99;
    right: 5%;
    ">
        <div class="toast__cell">
            <div class="toast toast--yellow add-margin" style="opacity: 1;">
                ...
                <div class="toast__content">
                    <p class="toast__type">Producto agotado</p>
                    <p class="toast__message">De momento no hay más productos disponibles.</p>
                </div>
                <div class="toast__close">
                    <svg class="toast__close" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 15.642 15.642" xmlns:xlink="http://www.w3.org/1999/xlink"
