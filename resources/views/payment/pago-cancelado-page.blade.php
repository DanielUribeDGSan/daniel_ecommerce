            ...
            <div class="col-lg-4 col-md-6 col-12 pl-0">
                <div class="card card-payment h-100">
                    <div class="card-body d-flex align-items-center justify-content-center">
                        {{-- <div> --}}
                        <div class="">
                            <p class="border-b-primary">Pago:</p> <span class="float-right mr-4">Rechazado</span><br>
                            ...
                            <p class="mt-3 text-center">Tu pago ha sido rechazado, verifica tu tarjeta y inténtalo de
                                nuevo.</p>
                            <div class="divisor-20"></div>
                            <div class="slider-btn btn-hover">
