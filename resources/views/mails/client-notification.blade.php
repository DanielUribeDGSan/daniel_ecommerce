                        ...
                        <tr style="border-collapse:collapse">
                            <td cellpadding="0" cellspacing="0" border="0"
                                style="padding:0;Margin:0;line-height:1px;min-width:600px" height="0"><img
                                    src="https://rqnfof.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png"
            ...
            <tr style="border-collapse:collapse">
                <td valign="top" style="padding:0;Margin:0">
                    <table class="es-header" cellspacing="0" cellpadding="0" align="center"
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" bgcolor="#e97730" style="padding:0;Margin:0;background-color:#e97730">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <a href="https://daniel-ecommerce-2021.herokuapp.com/"
                                                                        target="_blank"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#111111;font-size:14px"><img
                                                                            src="https://rqnfof.stripocdn.email/content/guids/CABINET_49e6516c3feebd4f2d7df613fc1aee23/images/3291631683554720.png"
                                                                            alt
                    ...
                    <table class="es-content" cellspacing="0" cellpadding="0" align="center"
                        ...
                        <tr style="border-collapse:collapse">
                            <td style="padding:0;Margin:0;background-color:#e97730" bgcolor="#e97730" align="center">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff" align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Un usuario ha realizado una nueva compra, da
                                                                        click en el botón de abajo para ver la orden.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <span class="es-button-border"
                                                                        style="border-style:solid;border-color:#FFA73B;background:#e97730;border-width:1px;display:inline-block;border-radius:2px;width:auto"><a
                                                                            href="https://daniel-ecommerce-2021.herokuapp.com/admin/orden"
                                                                            class="es-button es-button-1"
                                                                            target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;border-style:solid;border-color:#e97730;border-width:15px 30px;display:inline-block;background:#e97730;border-radius:2px;font-family:helvetica, helvetica neue, arial, verdana, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center">Ver
                                                                            orden</a></span>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, helvetica neue, helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                                                        <span style="text-align:center">Kasa shop</span>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
